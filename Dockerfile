...
RUN composer -n --working-dir=${TERMINUS_DIR} require --update-no-dev -o pantheon-systems/terminus:^2.4 \
    && composer -n create-project --no-dev -d ${TERMINUS_PLUGINS_DIR} pantheon-systems/terminus-build-tools-plugin:^2.0 \
